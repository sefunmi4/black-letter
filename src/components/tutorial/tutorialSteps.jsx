  ...
  community: [
    {
      ...
      description: "The community section helps you discover like-minded creators and join groups that match your interests.",
      tips: [
        "Join guilds based on your interests",
        "Use matchmaking to find potential collaborators",
        "Engage actively to build your network"
      ]
    },
    {
      title: "Guilds vs Matchmaking",
      description: "Guilds are communities around topics, while matchmaking helps you find individual collaborators for projects.",
      tips: [
        "Join guilds for ongoing community",
        "Use matchmaking for specific project needs",
        "Both help expand your creative network"
      ]
    }
  ],
